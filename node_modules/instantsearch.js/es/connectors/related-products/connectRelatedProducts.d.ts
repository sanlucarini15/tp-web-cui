...
declare const _default: <TWidgetParams extends object>(renderFn: Renderer<RelatedProductsRenderState<BaseHit>, RelatedProductsConnectorParams<BaseHit> & TWidgetParams>, unmountFn?: Unmounter) => <THit extends object = BaseHit>(widgetParams: TWidgetParams & RelatedProductsConnectorParams<THit>) => {
    dependsOn: "recommend";
    $$type: "ais.relatedProducts";
