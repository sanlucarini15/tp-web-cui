...
declare const _default: <TWidgetParams extends object>(renderFn: Renderer<LookingSimilarRenderState<BaseHit>, TWidgetParams & LookingSimilarConnectorParams<BaseHit>>, unmountFn?: Unmounter) => <THit extends object = BaseHit>(widgetParams: TWidgetParams & LookingSimilarConnectorParams<THit>) => {
    dependsOn: "recommend";
    $$type: "ais.lookingSimilar";
