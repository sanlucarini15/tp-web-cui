...
import type { MultiSearchQuery as MeiliSearchMultiSearchParams, MultiSearchResult, Config as MeilisearchConfig, MeiliSearch } from 'meilisearch';
...
export type OverridableMeiliSearchSearchParameters = Pick<MeiliSearchMultiSearchParams, 'attributesToRetrieve' | 'attributesToCrop' | 'cropLength' | 'cropMarker' | 'attributesToHighlight' | 'highlightPreTag' | 'highlightPostTag' | 'showMatchesPosition' | 'matchingStrategy' | 'showRankingScore' | 'attributesToSearchOn' | 'hybrid'>;
